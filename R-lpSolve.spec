...
Source0  : https://cran.r-project.org/src/contrib/lpSolve_5.6.21.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726243881
...
/usr/lib64/R/library/lpSolve/NEWS.md
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/lpSolve/libs/lpSolve.so
/V4/usr/lib64/R/library/lpSolve/libs/lpSolve.so
